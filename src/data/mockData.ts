...
const REAL_MONTHLY_DATA: MonthlyRealData[] = [
  {
    ...
    recurringRevenue: 278892, arpuRecurring: 40.18, arpuTotal: 50.44,
  },
  {
    ...
    recurringRevenue: 283030, arpuRecurring: 39.77, arpuTotal: 50.06,
  },
  {
    ...
    recurringRevenue: 286347, arpuRecurring: 39.30, arpuTotal: 50.35,
  },
  {
    ...
    recurringRevenue: 291419, arpuRecurring: 38.94, arpuTotal: 49.82,
  },
  {
    ...
    recurringRevenue: 289222, arpuRecurring: 39.10, arpuTotal: 50.15,
  },
  {
    ...
    recurringRevenue: 295982, arpuRecurring: 38.59, arpuTotal: 49.64,
  },
  {
    ...
    recurringRevenue: 297490, arpuRecurring: 38.25, arpuTotal: 49.48,
  },
  {
    ...
    recurringRevenue: 304309, arpuRecurring: 38.23, arpuTotal: 49.10,
  },
  {
    ...
    recurringRevenue: 332134, arpuRecurring: 38.94, arpuTotal: 52.60,
  },
  {
    ...
    recurringRevenue: 328352, arpuRecurring: 39.24, arpuTotal: 52.17,
  },
  {
    ...
    recurringRevenue: 326654, arpuRecurring: 40.79, arpuTotal: 55.39,
  },
  {
    ...
    recurringRevenue: 323796, arpuRecurring: 40.95, arpuTotal: 54.72,
  },
];
